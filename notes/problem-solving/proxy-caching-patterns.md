...
`learning/rendering/01-rendering-evolution-and-cdn.md`의 **3단계 진화** 관점에서 보면 명확하다.
...
1. **첫 화면 공백 문제 재발** — `learning/rendering/01-rendering-evolution-and-cdn.md §1`이 React의 고질병으로 꼽은 것. 카카오톡 인앱 브라우저 같은 느린 환경에서 체감 큼.
